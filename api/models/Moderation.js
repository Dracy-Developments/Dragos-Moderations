...
module.exports = {
  ...
  attributes: {
    ...
    type: {
      type: 'string',
      isIn: ['note', 'warning', 'discipline', 'antispam', 'reflection', 'restrictions', 'ban', 'investigation'],
      required: true,
    ...
    vpts: {
      ...
      min: 0,
      defaultsTo: 0,
      description: 'Number of violation points assigned to the member, if using vpts.'
    },
